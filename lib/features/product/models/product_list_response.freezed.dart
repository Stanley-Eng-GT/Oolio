...
mixin _$ProductListResponse {
  List<ProductModel> get d => throw _privateConstructorUsedError;
...
class _$ProductListResponseImpl implements _ProductListResponse {
  const _$ProductListResponseImpl({required final List<ProductModel> d})
      : _d = d;

  factory _$ProductListResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$ProductListResponseImplFromJson(json);

  final List<ProductModel> _d;
  @override
  List<ProductModel> get d {
    if (_d is EqualUnmodifiableListView) return _d;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_d);
  }

  @override
  String toString() {
    return 'ProductListResponse(d: $d)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other._d, _d));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(_d));
...
abstract class _ProductListResponse implements ProductListResponse {
  const factory _ProductListResponse({required final List<ProductModel> d}) =
