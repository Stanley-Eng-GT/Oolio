...
class _$CartItemModelImpl extends _CartItemModel {
  const _$CartItemModelImpl({required this.product, required this.count})
      : super._();
  ...
  @override
  String toString() {
    return 'CartItemModel(product: $product, count: $count)';
  }
...
abstract class _CartItemModel extends CartItemModel {
  const factory _CartItemModel(
      ...
      required final int count}) = _$CartItemModelImpl;
