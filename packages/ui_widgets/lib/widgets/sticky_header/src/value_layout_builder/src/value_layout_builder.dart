...
/// Builds a widget tree that can depend on the parent widget's size and an extra
/// value.
///
/// Similar to the [LayoutBuilder] widget except that the constraints contain
/// an extra value.
///
/// See also:
///
...
class ValueLayoutBuilder<T>
  ...
  RenderValueLayoutBuilder<T> createRenderObject(BuildContext context) =>
      RenderValueLayoutBuilder<T>(); // Changed to public
}
