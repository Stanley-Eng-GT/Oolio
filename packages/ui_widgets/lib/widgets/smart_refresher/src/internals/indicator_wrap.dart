...
mixin RefreshProcessor {
  ...
  /// When the indicator is ready to refresh, this function is called and waits for it to finish, then calls onRefresh.
  Future readyToRefresh() {
    return Future.value();
  }

  /// When the indicator is ready to dismiss, this function is called, and it will spring back after finishing.
  Future endRefresh() {
    return Future.value();
  }

  /// When the indicator has sprung back, it needs to reset its value.
  void resetValue() {}
}
...
mixin LoadingProcessor {
  ...
  /// When the indicator is ready to load, this function is called and waits for it to finish, then calls onRefresh.
  Future readyToLoad() {
    return Future.value();
  }
