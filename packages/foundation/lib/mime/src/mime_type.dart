...
/// be matched against.
FileType lookupMimeType(String path, {List<int>? headerBytes}) =>
    _getFileType(_globalResolver.lookup(path, headerBytes: headerBytes));

FileType _getFileType(String? typeString) {
  switch (typeString) {
    case 'image/gif':
    case 'image/jpeg':
    case 'image/png':
